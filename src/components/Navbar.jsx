        ...
        <div>
            ...
            <nav className="lg:flex hidden justify-between items-center w-full h-16 bg-slate-200">
                ...
                <div className='flex justify-center items-center gap-3 m-2'>
                    ...
                    {log ? 
                        <button className='bg-orange-500 text-white py-2 px-4 rounded-3xl' onClick={getlog}>Student LogIn</button> :
                        <button className='bg-orange-500 text-white py-2 px-4 rounded-3xl' onClick={update}>Student LogOut</button>}
                    {/* Change */}
            ...
            <div className='lg:hidden bg-slate-200'>
                ...
                {isMobileMenuOpen && (
                    <ul className='mx-2 p-2 mt-2 flex flex-col gap-4 text-gray-600 bg-slate-200 py-5 rounded-md'>
                        ...
                        {log ? 
                            <li className='hover:text-black cursor-pointer' onClick={getlog}>Student LogIn</li> :
                            <li className='hover:text-black cursor-pointer' onClick={update}>Student LogOut</li>}
                    </ul>
                )}
            </div>
        </div>
