...
import { FaUserGraduate, FaUserPlus, FaChalkboardTeacher, FaUserTie } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
        <h2 className="text-5xl font-bold mb-12 text-gray-800">Admin Dashboard</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 w-full max-w-6xl px-4">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold mb-2">Student Registration</h3>
            <p className="text-sm">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold mb-2">Teacher Registration</h3>
            <p className="text-sm">
