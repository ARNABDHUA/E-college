          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center border-b-2 border-gray-300 py-2">
              <svg className="h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 12h14M5 12l5 5m-5-5l5-5" />
              </svg>
              <input
                type="text"
                id="name"
            ...
            <div className="flex items-center border-b-2 border-gray-300 py-2">
              <svg className="h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 8c0 4-4 8-4 8s-4-4-4-8a4 4 0 118 0z" />
              </svg>
              <input
                type="email"
                id="email"
            ...
            <div className="flex items-center border-b-2 border-gray-300 py-2">
              <svg className="h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM12 13c-3.31 0-6 1.69-6 3v2h12v-2c0-1.31-2.69-3-6-3z" />
              </svg>
              <input
                type="password"
                id="password"
            ...
            <div className="flex items-center border-b-2 border-gray-300 py-2">
              <svg className="h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h16m-8 0l-4 4m4-4l4-4" />
              </svg>
              <input
                type="tel"
                id="phone"
            ...
            <div className="flex items-center border-b-2 border-gray-300 py-2">
              <svg className="h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 5c0 1.5-1.5 3-3 3-1.5 0-3-1.5-3-3s1.5-3 3-3c1.5 0 3 1.5 3 3zm-5 1.5c-2.5 0-5 1.5-5 4.5v6h10v-6c0-3-2.5-4.5-5-4.5z" />
              </svg>
              <input
                type="text"
                id="guardian"
